...
{
    /// <summary>
    /// An individual TSPVertice in our tour.
    /// </summary>
    public class TSPVertice
    {
        /// <summary>
        ...
        public TSPVertice(int x, int y, int id)
        {
            Id = id;
        ...
        /// <param name="shortestPathList"></param>
        public void FindClosestVertices(int numberOfCloseCities)
        {
